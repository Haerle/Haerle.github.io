...
string usernames[] = { "c.smith", "K.black", "p.garcia" };
string passwords[] = { "apple", "puppy", "cat" };
string clients[] = { "Chris Haerle", "Sammie Davis", "Ultimate Warrior", "Captain America",
                     "Hulk" };
...
void ChangeCustomerChoice() {
    ...
    cout << "Created by Chris Haerle." << endl;
...
int main() {
    ...
    cout << "Program written by Chris Haerle" << endl;
